...
urlpatterns = [
    ...
    path('room_request/<slug:rq_id>', views.room_request, name="room_request"),
    ...
    path('room_request_active/<slug:al_id>',views.room_request_active,name="room_request_active"),
    path('room_allot_pending/',views.room_allot_pending,name="room_allot_pending"),
    path('roomallot/active/<slug:a_id>', views.allot_active,name="allot_active"),
    path('roomallot/pending/<slug:p_id>', views.allot_pending,name="allot_pending"),
    path('roomallot/delete/<slug:d_id>', views.allot_delete,name="allot_delete"),
